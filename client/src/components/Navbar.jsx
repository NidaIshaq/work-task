...
export default function Navbar() {
  ...
  <Link className="navbar-brand md:me-8 flex items-center" to="/">
    <img src={logoDark} className="inline-block dark:hidden h-12 w-12" alt="Logo" />
    {/* <img src={logoLight} className="hidden dark:inline-block h-12 w-12" alt="Logo" /> */}
    <p className="font-bold h-auto w-auto text-teal-500 ml-2">Pet Care</p>
  </Link>
